...
\begin{center}
    ...
    \vspace{1cm}
    {\Large\textcolor{mainblue}{\textbf{Zero voting power for retail investors}}}
...
% Slide 12: Compliant Global Economic Access
\begin{frame}{Compliant Global Economic Access}
\vspace{0.5cm}
\begin{center}
    \begin{tikzpicture}
        % KYC Flow
        \node[rectangle,fill=lightblue,text=white,minimum width=3cm,minimum height=1.2cm,rounded corners] at (-4,0) {
            \Large\faUser\ User
        };
        
        \draw[->,ultra thick,mainblue] (-2.5,0) -- (-1,0);
        
        \node[rectangle,fill=accentgold,text=white,minimum width=3.5cm,minimum height=1.2cm,rounded corners] at (0,0) {
            \Large\faIdCard\ KYC Check
        };
        
        \draw[->,ultra thick,mainblue] (1.75,0) -- (3.25,0);
        
        \node[rectangle,fill=mainblue,text=white,minimum width=3cm,minimum height=1.2cm,rounded corners] at (5,0) {
            \Large\faCheckCircle\ Verified
        };
        
        % Security features below
        \node[rectangle,fill=lightblue!30,draw=mainblue,thick,minimum width=10cm,minimum height=2cm,rounded corners] at (0.5,-2.5) {
            \begin{minipage}{9cm}
                \centering
                \textcolor{mainblue}{\faShieldAlt\ \textbf{Regulatory Compliance}}\\
                \vspace{0.2cm}
                \textcolor{darkgray}{SEC-compliant • AML/KYC verified • Global access}
            \end{minipage}
        };
    \end{tikzpicture}
    
    \vspace{0.8cm}
    {\Large\textbf{Secure, compliant, and accessible}}
    
    \vspace{0.3cm}
    {\large Regulation-friendly governance for everyone}
\end{center}
\end{frame}
